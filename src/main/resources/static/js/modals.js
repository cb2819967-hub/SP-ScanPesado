...
async function saveVehiculo() {
  ...
  // Get cliente object based on selection
  const clienteSelect = document.querySelectorAll('#m-veh select')[1];
  // Normally you'd get the actual ID from value, mock it for now or assume backend ignores it if you don't send id
